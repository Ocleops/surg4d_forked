...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default=(
            "a surgical instrument,grasper,hook,scissors,a clip applier,"
            "an irrigator,bipolar forceps,a specimen bag,a suction instrument,"
            "a needle driver,surgical tissue,fat tissue,blood,background"
        ),
