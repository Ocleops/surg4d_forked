...
def _embed_clip_sam_tiles(image, sam_encoder, precomp_seg_path=None, modes=None):
...
if __name__ == "__main__":
    ...
    GLOBAL_CLIP_MODEL = OpenCLIPNetwork(OpenCLIPNetworkConfig)
    # import time
    ...
    if args.dataset_type == "hypernerf":
        ...
        for resolution in resolution_list:
            ...
            save_folder = os.path.join(
                dataset_path,
                "language_features"
                if args.precompute_seg is None
            ...
            images = [
                img_list[i].permute(2, 0, 1)[None, ...] for i in range(len(img_list))
            ]
        ...
        cam_dirs = [
            ...
            if os.path.isdir(os.path.join(dataset_path, d)) and d.startswith("cam")
        ]
